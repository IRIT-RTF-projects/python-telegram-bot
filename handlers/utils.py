...
from crud import location_crud, subscription_crud, user_crud
from models import Location, User, Subscription
...
async def check_location_exists(
    ...
    return await location_crud.get_by_multiple_attributes(
